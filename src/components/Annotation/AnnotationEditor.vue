        ...
        <div class="editor-field editor-field-content">
          ...
          <div class="tiptap-toolbar" v-if="editor">
            ...
            <div class="toolbar-fontsize-wrap" v-click-outside="() => (fontsizeOpen = false)">
              <button
                type="button"
                class="toolbar-fontsize-btn"
                :class="{ active: fontsizeOpen }"
            ...
            <div class="toolbar-color-btn" title="文字颜色">
              ...
              <input
                ...
                @input="
                  (e) => {
                    currentTextColor = (e.target as HTMLInputElement).value
            ...
            <div class="toolbar-color-btn" title="背景高亮">
              <span
                class="color-a-text"
                :style="{ background: currentHighlight, padding: '0 2px', borderRadius: '2px' }"
                >A</span
              >
              <input
                type="color"
                ...
                @input="
                  (e) => {
                    currentHighlight = (e.target as HTMLInputElement).value
                    editor?.chain().focus().toggleHighlight({ color: currentHighlight }).run()
                  }
                "
              />
            </div>
            ...
            <button type="button" @click="insertTable" title="插入表格">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path
                  d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 2v3H5V5h15zm-8 5h8v3h-8v-3zm0 5h8v4h-8v-4zM5 10h5v3H5v-3zm0 5h5v4H5v-4z"
                />
              </svg>
            </button>
            <button
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path
                  d="M20 13H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h17c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zm-1 6H4v-4h15v4zM11 3H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h8v-2H4V5h7V3zm9 4h-2V5h-2V7h-2v2h2v2h2V9h2V7z"
                />
              </svg>
            </button>
            <button
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path
                  d="M20 13H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h17c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zm-1 6H4v-4h15v4zM11 3H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h8V8H4V5h7V3zm6 4l-3 3 3 3 1.4-1.4L16.8 10l1.6-1.6L17 7z"
                />
              </svg>
            </button>
            <button
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path
                  d="M11 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h6v14zm9-8h-2V9h-2v2h-2v2h2v2h2v-2h2v-2z"
                />
              </svg>
            </button>
            <button
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path
                  d="M11 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h6v14zm7-5l3-3-3-3-1.4 1.4 1.6 1.6-1.6 1.6L18 14z"
                />
              </svg>
            </button>
            <button
