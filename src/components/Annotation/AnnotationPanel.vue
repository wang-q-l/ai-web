...
<template>
  <Transition name="panel-fade">
    <div v-if="annotation" ref="panelRef" class="annotation-panel" :style="panelStyle">
      <!-- 拖动把手：标题栏 -->
      ...
      <div class="panel-body">
        <div class="panel-meta">
          <span class="meta-tag" :class="`meta-tag-${annotation.category}`">{{
            categoryLabel
          }}</span>
      ...
      <div v-if="editMode" class="panel-footer">
        <button class="panel-btn" @mousedown.stop @click="$emit('edit', annotation.id)"
          >编辑</button
        >
        <button
