 ...
 */
import { MenuThemeEnum, MenuTypeEnum, SystemThemeEnum, FrameworkTypeEnum } from '@/enums/appEnum'
...
const appConfig: SystemConfig = {
  ...
  // 框架布局列表
  frameworkLayoutList: [
    { name: '框架一', value: FrameworkTypeEnum.FRAMEWORK_ONE, img: '/images/framework-one.png' },
    { name: '框架二', value: FrameworkTypeEnum.FRAMEWORK_TWO, img: '/images/framework-two.png' }
  ],
  // 菜单主题列表
  themeList: [
    {
