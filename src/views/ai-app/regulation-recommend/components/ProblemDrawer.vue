<script setup lang="ts">
  ...
  const form = ref({
    ...
    description:
      '2016-2018年，县发改局均按照储备粮中心库建设项目整个工程估算总投资额5945万元与上年财政实际累计拨付金额间的差额编制年度预算，而未按照该项目预计项目进度编制。2016-2018年度县财政分别安排2516万元、700万元、580.3万元，实际支出分别为1816.59万元、341.12万元、41.46万元，执行率分别为72.20%、48.73%、7.14%。',
    category: '预算管理',
    isAmountIssue: 'yes',
