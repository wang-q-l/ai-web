    ...
    <el-card class="breadcrumb-card">
      <div class="breadcrumb-content">
        ...
        <div class="breadcrumb-actions" v-if="currentStage">
          <el-tag
            :type="getStageTagType(currentStage.status)"
            size="small"
        ...
        <div class="stage-nav">
          <div
            ...
            :class="{
              ...
              'is-completed':
                stage.status === StageStatus.Completed || stage.status === StageStatus.Approved,
          ...
          <div class="stage-detail">
            ...
            <template v-if="currentStage.stageName === '准备阶段'">
              ...
              <template v-if="activeSubNode === 'notice'">
                <el-card class="content-card">
                  ...
                  <div class="notice-content">{{
                    currentStage.noticeContent || '暂无通知书内容'
                  }}</div>
                </el-card>
              </template>
              ...
              <template v-if="activeSubNode === 'items'">
                <el-card class="content-card">
                  ...
                  <el-table :data="currentStage.auditItems" size="small">
                    ...
                    >
                      <template #default="{ row }">
                        ...
                        <el-button link type="danger" @click="handleDeleteItem(row.id)"
                          >删除</el-button
                        >
                      </template>
                    </el-table-column>
                  ...
                  <el-empty
                    v-if="!currentStage.auditItems?.length"
                    description="暂无审计事项"
                    :image-size="60"
                  />
                </el-card>
            ...
            <template v-if="currentStage.stageName === '实施阶段'">
              ...
              <el-card class="content-card">
                ...
                <el-table :data="currentStage.findings" size="small">
                  ...
                  >
                    <template #default="{ row }">
                      <el-button link type="danger" @click="handleDeleteFinding(row.id)"
                        >删除</el-button
                      >
                    </template>
                  </el-table-column>
                ...
                <el-empty
                  v-if="!currentStage.findings?.length"
                  description="暂无审计发现"
                  :image-size="60"
                />
              </el-card>
            ...
            <el-card class="content-card">
              ...
              <div class="record-list">
                ...
                <el-empty
                  v-if="!currentStage.workRecords?.length"
                  description="暂无工作记录"
                  :image-size="60"
                />
              </div>
    ...
    <el-dialog v-model="findingDialogVisible" title="添加审计发现" width="560px">
      <el-form :model="findingForm" label-width="90px" ref="findingFormRef">
        ...
        <el-form-item
          label="涉及部门"
          prop="department"
          :rules="[{ required: true, message: '请输入涉及部门' }]"
        >
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="handleSubmitFinding" :loading="addingFinding"
          >确定</el-button
        >
      </template>
    </el-dialog>
    ...
    >
      <el-form :model="itemForm" label-width="90px" ref="itemFormRef">
        ...
        <el-form-item
          label="审计内容"
          prop="content"
          :rules="[{ required: true, message: '请输入审计内容' }]"
        >
          <el-input
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="handleSubmitItem" :loading="submittingItem"
          >确定</el-button
        >
      </template>
    </el-dialog>
...
<script setup lang="ts">
  ...
  async function handleSubmitItem() {
    ...
    const assignedMembers =
      project.value?.members.filter((m) => itemForm.assignedMemberIds.includes(m.id)) || []
  ...
  async function handleGeneratePlan() {
    ...
    try {
      await ElMessageBox.confirm('确认根据当前审计事项生成审计实施方案？', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'info'
      })
