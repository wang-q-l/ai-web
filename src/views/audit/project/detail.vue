      ...
      <div class="detail-content" v-if="project">
        ...
        <el-card class="info-card">
          ...
          <el-descriptions :column="3" border>
            ...
            <el-descriptions-item label="整改完成率"
              >{{ project.rectificationRate }}%</el-descriptions-item
            >
          ...
          <div class="viewers-section">
            <div class="viewer-group">
              ...
              <div class="viewer-list">
                ...
                >
                  {{ viewer.name }}
                  <span v-if="viewer.department" class="viewer-dept"
                    >（{{ viewer.department }}）</span
                  >
                </el-tag>
...
<script setup lang="ts">
  ...
  // ---- 权限管理 ----
  const auditViewers = computed(
    () => project.value?.viewers.filter((v) => v.type === 'audit') || []
  )
  const receptionViewers = computed(
    () => project.value?.viewers.filter((v) => v.type === 'reception') || []
  )
